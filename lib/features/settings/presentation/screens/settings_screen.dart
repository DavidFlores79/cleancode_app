...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _loadThemeConfig() async {
    ...
    setState(() {
      ...
      selectedColor = primaryColorString != null ? Color(int.parse(primaryColorString)) : Colors.blue;
    });
  }
  @override
                 ...
                 children: [
                    SwitchListTile(
                      ...
                      onChanged: (value) async {
                          ...
                          context.read<SettingsBloc>().add(ToggleTheme(isDarkMode: value, primaryColor: selectedColor));
            ...
            content: SingleChildScrollView(
              child: ColorPicker(
                  ...
                  onColorChanged: (color) async {
                    ...
                    context.read<ThemeManager>().changeColor(color);
                     context.read<SettingsBloc>().add(ChangeColor(isDarkMode: isDarkMode, primaryColor: selectedColor));
                    },
                    ),
              ),
                actions: <Widget>[
